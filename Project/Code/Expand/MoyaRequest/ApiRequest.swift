...
//  RS
//
//  Created by Aalto on 2017/12/15.
...
@objcMembers public class ApiRequest {
    /// 使用moya的请求封装
    ///
    /// - Parameters:
...
//        let api = ApiManger.postParamsRankList(param: "", param2: "")
